...
%
% Test case from https://doi.org/10.1364/JOSAA.14.002758, Example 3, but
% with a different unit cell. The metal permittivity (stratum_pmt) for this
% case is stated in JOSA as 1+5i, but it is apparently supposed to be
% (1+5i)^2; see Example 4 and Figure 6 in
% https://doi.org/10.1088/1464-4258/5/4/307.
%
...
if 0
    ...
    disp('The number of ''teeth'' (N) is reduced to allow plotting.')
    N = 13;
end
...
grating.d22 = d*(1+sind(zeta));
grating.d32 = d*cosd(zeta);
