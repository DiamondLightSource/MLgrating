function [R1,R2,R3,R4,R_m1]=MLgrating_sim_all_orders(grating,PGM,m_max)

disp(['Simulating at ' num2str(PGM.energy) ...
	' eV, with c_ff = ' num2str(PGM.cff) ...
	' for order = '  num2str(PGM.order) ' ...'])
% start timer
tStart = tic;
...
disp(['Elapsed time was ' num2str(time_elapsed) ' s'])